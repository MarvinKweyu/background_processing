defmodule BackgroundProcessingWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BackgroundProcessingWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BackgroundProcessingWeb.Gettext, "errors", msg, opts)
    end
  end
